...
/* Read from what was built rather than from the config, so this stays a
   plain script with no TypeScript import chain behind it. A tenant is a
   directory with its own home page; assets and shared files are not. */
const NOT_TENANTS = new Set(['_astro', 'pagefind', 'pdf', 'articles', 'projects']);
